...
class LaTeX {
    ...
    public function enqueue_scripts() {        
        wp_register_style('katex', plugins_url('LaTeX/assets/katex/0.9.0/katex.min.css', dirname(__FILE__)), false, '0.9.0');
		wp_register_script('katex', plugins_url('LaTeX/assets/katex/0.9.0/katex.min.js', dirname(__FILE__)), array(), '0.9.0', true);
    }
